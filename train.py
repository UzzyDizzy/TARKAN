...
if __name__ == "__main__":
    ...
    ap.add_argument("--lambda3", type=float, default=CONFIG.lambda3)
    ap.add_argument("--fusion", default=CONFIG.fusion)
    args = ap.parse_args()
    cfg = replace(CONFIG, device=args.device, lambda1=args.lambda1, lambda2=args.lambda2, lambda3=args.lambda3, fusion=args.fusion)
